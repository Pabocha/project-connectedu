...
# gestion_ecole_2
router.register('emploi-du-temps', EmploiDuTempView, basename='emploi-du-temps')
router.register('appreciation', AppreciationView, basename='appreciation')
router.register('annonce', AnnonceView, basename='annonce')
router.register('releve-presence', RelevePresenceView, basename='releve-presence')
router.register('comptable', ComptableView, basename='comptable')
